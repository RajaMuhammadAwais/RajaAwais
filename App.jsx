          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="about-images-cyberpunk">
                <img src={process.env.BASE_URL ? process.env.BASE_URL + 'assets/devops_reference.jpg' : '/assets/devops_reference.jpg'} alt="DevOps Reference" className="cyberpunk-img neon-border" />
                <img src={process.env.BASE_URL ? process.env.BASE_URL + 'assets/robotics_reference.jpg' : '/assets/robotics_reference.jpg'} alt="Robotics Reference" className="cyberpunk-img neon-border" />
              </div>
            </div>
